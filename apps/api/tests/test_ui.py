...
def test_app_static_assets_are_served(client: TestClient) -> None:
    ...
    assert 'from "./ui.js?v=g75a4"' in app_js_response.text
    assert 'from "./api.js?v=g75a4"' in app_js_response.text
    assert 'from "./storage.js?v=g75a4"' in app_js_response.text
    assert 'from "./validation.js?v=g75a4"' in app_js_response.text
